...
<h1 id="title" className="uploadTitle"><span className="title">Upload</span><br/>your 3D-asset</h1>
<form id = "uploadForm" encType = "multipart/form-data" action="http://localhost:4000/model" method="post" onSubmit={change}>
...
<br/>
<input hidden type="text" value={localStorage.getItem("size")} name="size"/>
